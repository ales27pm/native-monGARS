...
describe('HomeScreen', () => {
  beforeEach(() => {
    jest.clearAllMocks();
    (useAssistantStore as unknown as jest.Mock).mockReturnValue(mockStoreState);
  });
  ...
  it('renders correctly when ARIA is active', () => {
    ...
    (useAssistantStore as unknown as jest.Mock).mockReturnValue(activeStoreState);
  ...
  it('shows current mode selection', () => {
    ...
    (useAssistantStore as unknown as jest.Mock).mockReturnValue(chatModeState);
