...
Based on this audio input and my current context, provide insights about what the user said, any actions I should take, and relevant observations or recommendations.`;
      ...
      if (!errorMessage) {
        errorMessage = 'Failed to analyze audio. Please try again.';
      }
      if (errorMessage?.includes('API_KEY') || errorMessage?.includes('API key')) {
        errorMessage = 'Audio transcription service is temporarily unavailable. The app is running in demo mode with mock responses.';
