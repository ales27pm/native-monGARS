...
export default function HomeScreen() {
  ...
  useEffect(() => {
    logger.info('HomeScreen', 'Home screen mounted');
    ...
    return () => {
      ...
      logger.info('HomeScreen', 'Home screen unmounted');
    };
  }, [checkAllServices]);

  const handleNavigateToChat = () => {
    logger.info('HomeScreen', 'Navigating to chat');
    // @ts-ignore - Navigation types not fully configured
    navigation.navigate('Chat');
  };

  const handleNavigateToVoice = () => {
    logger.info('HomeScreen', 'Navigating to voice');
    // @ts-ignore - Navigation types not fully configured
    navigation.navigate('Voice');
  };

  const handleNavigateToTools = () => {
    logger.info('HomeScreen', 'Navigating to tools');
    // @ts-ignore - Navigation types not fully configured
    navigation.navigate('Tools');
  };

  const handleNavigateToSettings = () => {
    logger.info('HomeScreen', 'Navigating to settings');
    // @ts-ignore - Navigation types not fully configured
