...
export default function HomeScreen({ navigation }: any) {
  ...
  useEffect(() => {
    ...
    sensorManager.setDataUpdateCallback((data) => {
    ...
    <SafeAreaView className="flex-1 bg-gray-50">
      <View style={{ paddingTop: insets.top }}>
        <ScrollView className="flex-1 px-4">
          ...
          <Animated.View entering={FadeInDown.delay(250)} className="mb-6">
            <Pressable
              onPress={() => navigation.navigate('EnhancedChat')}
              className="rounded-2xl p-6 items-center shadow-lg border-2 border-purple-200"
              style={{ backgroundColor: '#F3E8FF' }}
            >
              <View className="flex-row items-center mb-2">
                <Ionicons name="bulb" size={32} color="#7C3AED" />
                <Text className="text-purple-700 text-xl font-bold ml-2">Enhanced ARIA</Text>
              </View>
              <Text className="text-purple-600 text-center text-sm leading-5">
                Advanced AI with memory, learning, specialized agents, and chain-of-thought reasoning
              </Text>
              <View className="flex-row items-center mt-3">
                <View className="bg-purple-100 rounded-full px-2 py-1 mr-1">
                  <Text className="text-purple-600 text-xs">Memory</Text>
                </View>
                <View className="bg-purple-100 rounded-full px-2 py-1 mr-1">
                  <Text className="text-purple-600 text-xs">Agents</Text>
                </View>
                <View className="bg-purple-100 rounded-full px-2 py-1 mr-1">
                  <Text className="text-purple-600 text-xs">Learning</Text>
                </View>
          ...
          <Animated.View entering={FadeInDown.delay(500)} className="mb-6">
            ...
            <ModeCard
              mode="enhanced"
              title="Enhanced Chat"
              description="Advanced AI with memory, agents & chain-of-thought"
              icon="bulb"
              onPress={() => {
                setMode('enhanced');
            ...
            <Animated.View entering={FadeInDown.delay(600)} className="mb-8">
              ...
              <View className="flex-row justify-between">
                ...
                >
                  ...
                  <Text className="text-sm font-medium text-gray-700 mt-1">Cache</Text>
                </Pressable>
                ...
                <Pressable
                  ...
                  className="bg-white rounded-xl p-4 items-center flex-1 mx-1 shadow-sm border border-gray-200"
                >
                  <Ionicons name="build-outline" size={24} color="#8B5CF6" />
                  <Text className="text-sm font-medium text-gray-700 mt-1">Auto Mode</Text>
                </Pressable>
